...
public class TC_02 extends CognitestPageHook {
    ...
    public void Employeesearch() {
        ...
        new MenuPage()
                ...
                .navigateToPIMModule()
                .configuration()
                .selectionofOptionalfields()
                .changeToggleShowDeprecatedFields()
                .changeToggleShowSSNField()
                .changeToggleShowSINField()
                .changeToggleShowUSTaxExemptions()
                .creationofOptionalfield();
